...
public class DrawPanel extends JPanel {
    ...
    private ObjectsNearTheHouse objectsNearTheHouse = new ObjectsNearTheHouse(800, 1300, 750, 400, 780, 700, new Color(119, 136, 153), new Color(112, 128, 144), new Color(135, 206, 235), new Color(85, 220, 36));
